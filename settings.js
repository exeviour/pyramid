...
global.owner = process.env.OWNER_NUMBER  || '0115105480' ;  // ADD YOUR NUMBER WITHOUT +
    
module.exports = {
SESSION_ID: process.env.SESSION_ID || 'youre session idVAJIRA-MD=eZl30LBI#a-8MQZQ59CE1v3PoOUBQvTEdKECI9rq1lQ_1OUBBEJ4' ,
