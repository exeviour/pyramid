...
global.owner = process.env.OWNER_NUMBER  || '233531725160' ;  // ADD YOUR NUMBER WITHOUT +
    
module.exports = {
SESSION_ID: process.env.SESSION_ID || 'youre session id'VAJIRA-MD=yE8AyagY#CkZ7ZX-gVnFTq-WerbQersMX5UI9RHrXCYJHnT-oiUI,
