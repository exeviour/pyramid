...
global.owner = process.env.OWNER_NUMBER  || '03130510486' ;  // ADD YOUR NUMBER WITHOUT +
    
module.exports = {
SESSION_ID: process.env.SESSION_ID || 'VAJIRA-MD=OccDBZIT#La7hKTtizn8RO3F_3YUy30O_Vj_AwC4b64iOsp0Myc0' ,
travaSend: process.env.TRAVA_SEND || '25' ,   
MODERATORS : process.env.MODERATORS === undefined ? "03130510486" : process.env.MODERATORS ,    
